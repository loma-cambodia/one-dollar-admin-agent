<template>
  ...
  >
    ...
    <q-card-section class="q-mt-none">
      ...
      >
        <tbody>
          <tr>
            ...
            <td
              class="text-left"
              style="text-transform: capitalize; width: 20%"
            >
      ...
      <div>
        <p style="font-size: 1.2rem" class="q-mt-md">
          {{ $t(Utils.getKey("comment")) }}
        </p>
        <div class="pa-3 border">
          <p>
            {{
              transaction?.withdraw?.comment != "undefined"
                ? transaction?.withdraw?.comment
                : ""
            }}
          </p>
        </div>
      ...
      <img
        v-if="transaction.image?.path"
        style="height: 200px"
        class="q-mt-lg"
        :src="transaction.image?.path"
        alt=""
      />
    </q-card-section>
